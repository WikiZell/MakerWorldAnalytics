...
The partition table reserves NVS, OTA metadata, two 1.5 MiB OTA application slots, 896 KiB LittleFS, and a 64 KiB core-dump partition for crash diagnostics.
